...
CREATE TABLE epss_servicios
(
    epss_nit     NUMBER(38, 0) NOT NULL,
...
CREATE TABLE ipss_medicos
(
    ips_nit              NUMBER(38, 0) NOT NULL,
    medicos_num_registro NUMBER(38, 0) NOT NULL
);

CREATE TABLE ipss_servicios
(
    epss_nit     NUMBER(38, 0) NOT NULL,
    servicios_id NUMBER(38, 0) NOT NULL
);
...
ALTER TABLE ipss_medicos
    ADD CONSTRAINT uc_ipss_medicos_medicos_numregistro UNIQUE (medicos_num_registro);

ALTER TABLE afiliados
    ADD CONSTRAINT FK_AFILIADOS_ON_CONTRIBUYENTE_NUMDOC FOREIGN KEY (contribuyente_num_doc) REFERENCES afiliados (num_doc);
...
ALTER TABLE epss_servicios
    ADD CONSTRAINT fk_epsser_on_e_p_s FOREIGN KEY (epss_nit) REFERENCES epss (nit);

ALTER TABLE epss_servicios
    ADD CONSTRAINT fk_epsser_on_servicio_salud FOREIGN KEY (servicios_id) REFERENCES servicios (id);

ALTER TABLE ipss_medicos
    ADD CONSTRAINT fk_ipsmed_on_i_p_s FOREIGN KEY (ips_nit) REFERENCES ipss (nit);

ALTER TABLE ipss_medicos
    ADD CONSTRAINT fk_ipsmed_on_medico FOREIGN KEY (medicos_num_registro) REFERENCES medicos (num_registro);

ALTER TABLE ipss_servicios
    ADD CONSTRAINT fk_ipsser_on_i_p_s FOREIGN KEY (epss_nit) REFERENCES ipss (nit);

ALTER TABLE ipss_servicios
    ADD CONSTRAINT fk_ipsser_on_servicio_salud FOREIGN KEY (servicios_id) REFERENCES servicios (id);
CREATE SEQUENCE citas_serviciosipss_seq START WITH 1 INCREMENT BY 50;
...
(
    ...
    contribuyente_num_doc NUMBER(38, 0),
    CONSTRAINT pk_beneficiario PRIMARY KEY (num_doc)
);
...
ALTER TABLE beneficiario
    ADD CONSTRAINT FK_BENEFICIARIO_ON_CONTRIBUYENTE_NUMDOC FOREIGN KEY (contribuyente_num_doc) REFERENCES afiliados (num_doc);

ALTER TABLE beneficiario
    ADD CONSTRAINT FK_BENEFICIARIO_ON_NUMDOC FOREIGN KEY (num_doc) REFERENCES afiliados (num_doc);
...
ALTER TABLE ipss_servicios
    ADD CONSTRAINT fk_ipsser_on_i_p_s FOREIGN KEY (ips_nit) REFERENCES ipss (nit);

ALTER TABLE ipss_servicios
    ADD CONSTRAINT fk_ipsser_on_servicio FOREIGN KEY (servicios_id) REFERENCES servicios (id);